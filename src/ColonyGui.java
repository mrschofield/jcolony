...
public class ColonyGui extends JFrame implements ActionListener, ColonyObserver
{
	...
	*/
	...
	/*! void actionPerformed(ActionEvent e_)
		\e Purpose
	...
	*/
	...
	/*! String stateToString(int state_)
		\e Purpose
	...
	*/
	...
	/*! String stopStatusToString(int stopStatus_)
		\e Purpose
